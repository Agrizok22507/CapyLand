# CapyLand.py update 31.05.2025 v1.0.2
import win32gui
import win32con
import win32api
from tkinter import *
...
cmd = "ctrl + g"
reload_ = "ctrl + r"
# minimize_last_window = "ctrl + h" Не работает
minimize_current_window = "ctrl + u"
def cmd_():
...
def is_real_app_window(hwnd):
    ...
    false_titles = ["Параметры", "Медиаплеер", "Калькулятор", "Microsoft Text Input Application", "Проводник", "TextInputHost", "Calculator", "Application Frame Host", "Microsoft"]
...
def minimize_cur():
    ...
    win32gui.ShowWindow(cur, win32con.SW_MINIMIZE)
...
if __name__ == "__main__":
    ...
    try:
        ...
        keyboard.add_hotkey(reload_, reload)
        keyboard.add_hotkey(minimize_current_window, minimize_cur)
    except Exception as e:
